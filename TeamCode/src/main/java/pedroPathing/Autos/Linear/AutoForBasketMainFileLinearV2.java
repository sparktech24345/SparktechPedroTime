...
public class AutoForBasketMainFileLinearV2 extends LinearOpMode {
    /// FOARTE IMPORTANT: CULOAREA ALIANTEI!
    private colorList teamColor = colorList.red;

    public AutoForBasketMainFileLinearV2(colorList color){
    ...
    private final Pose firstSampleCollect = new Pose( 44.36073123000739, -4.973073343592366 - 0.25, Math.toRadians(86));
    private final Pose secondSampleCollect = new Pose(47.7603317621186, -6.255474541130967 - 0.75, (1.4780077934265137));
...
//        startPath.setLinearHeadingInterpolation(startPose.getHeading(), scoringBarPosePreloadSpecimen.getHeading());
        ...
        preloadScorePath = follower.pathBuilder()
                .addPath(new BezierLine(new Point(startPose), new Point(firstSampleCollect)))
                .setLinearHeadingInterpolation(startPose.getHeading(), firstSampleCollect.getHeading())
                .build();
...
//                .build();
    ...
    private final int basketDropTimer = 500;
