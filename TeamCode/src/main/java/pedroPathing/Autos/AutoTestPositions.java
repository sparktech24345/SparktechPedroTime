...
public class AutoTestPositions extends OpMode {
    ...
    public void loop() {
        ...
        tel.addData("velocity",follower.getVelocity().getMagnitude());
        tel.addData("velocity",follower.getVelocity().getXComponent());
        tel.addData("velocity",follower.getVelocity().getYComponent());
        tel.update();
    }
